...
% \setCJKmainfont[AutoFakeBold=true, Path=fonts/, BoldFont=simhei.ttf, ItalicFont=simkai.ttf]{simsun.ttc}
% \setCJKsansfont[Path=fonts/, BoldFont=simhei.ttf]{simkai.ttf}
% \setCJKmonofont[Path=fonts/, BoldFont=simhei.ttf]{simfang.ttf}
% \setCJKfamilyfont{zhsong}[AutoFakeBold=true, Extension=.ttc, Path=fonts/]{simsun.ttc}
